...
test_driver.find_element(By.CSS_SELECTOR, '#reg_email').send_keys('quan32132@gmail.com')
time.sleep(1)

# Nhập dữ liệu vào field 'password'
test_driver.find_element(By.CSS_SELECTOR, '#reg_password').send_keys('quan 1231223')
time.sleep(1)

# Nhập dữ liệu vào field 'họ tên'
test_driver.find_element(By.CSS_SELECTOR, '#reg_hoten').send_keys('Quân Phùng')
time.sleep(1)

# select box "giới tính" và chọn giới tính "Nam"
...
button = test_driver.find_element(By.XPATH, '/html/body/div[14]/div[2]/div/center/div/div/div/form/div/table/tbody/tr[9]/td[2]/input').click()
